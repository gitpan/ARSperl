...
unless (defined &__FLT_DENORM_MIN__) { sub __FLT_DENORM_MIN__() { "1\.40129846e\-45F" } }

unless (defined &__FLT_DIG__) { sub __FLT_DIG__() { 6 } }

unless (defined &__FLT_EPSILON__) { sub __FLT_EPSILON__() { "1\.19209290e\-7F" } }
...
unless (defined &__FLT_MAX__) { sub __FLT_MAX__() { "3\.40282347e\+38F" } }

unless (defined &__FLT_MIN_10_EXP__) { sub __FLT_MIN_10_EXP__() { "\(\-37\)" } }

unless (defined &__FLT_MIN_EXP__) { sub __FLT_MIN_EXP__() { "\(\-125\)" } }

unless (defined &__FLT_MIN__) { sub __FLT_MIN__() { "1\.17549435e\-38F" } }
...
unless (defined &__INTMAX_TYPE__) { sub __INTMAX_TYPE__() { "long\\" } }

unless (defined &__INT_MAX__) { sub __INT_MAX__() { 2147483647 } }

unless (defined &__LDBL_DENORM_MIN__) { sub __LDBL_DENORM_MIN__() { "3\.64519953188247460253e\-4951L" } }

unless (defined &__LDBL_DIG__) { sub __LDBL_DIG__() { 18 } }

unless (defined &__LDBL_EPSILON__) { sub __LDBL_EPSILON__() { "1\.08420217248550443401e\-19L" } }
...
unless (defined &__LDBL_MIN__) { sub __LDBL_MIN__() { "3\.36210314311209350626e\-4932L" } }
...
unless (defined &__SIZE_TYPE__) { sub __SIZE_TYPE__() { "unsigned\\" } }

unless (defined &__STDC_HOSTED__) { sub __STDC_HOSTED__() { 1 } }

unless (defined &__STDC__) { sub __STDC__() { 1 } }

unless (defined &__UINTMAX_TYPE__) { sub __UINTMAX_TYPE__() { "long\\" } }
...
unless (defined &__VERSION__) { sub __VERSION__() { "\"4\.1\.2\\" } }

unless (defined &__WCHAR_MAX__) { sub __WCHAR_MAX__() { 2147483647 } }

unless (defined &__WCHAR_TYPE__) { sub __WCHAR_TYPE__() { "long\\" } }

unless (defined &__WINT_TYPE__) { sub __WINT_TYPE__() { "unsigned\\" } }
